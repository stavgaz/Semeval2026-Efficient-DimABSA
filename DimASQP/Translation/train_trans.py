...
def main():
    ...
    output_dir = f"/leonardo_work/EUHPC_D19_014/dimABSA/dimABSA/trans_res/{args.subtask}/{run.id}/{args.language}"
    train_output_path = f"{output_dir}/{args.language}_{args.domain}_train_prompts.jsonl"
    train_path = f"/leonardo_work/EUHPC_D19_014/dimABSA/dimABSA/translated_{args.language}_{args.domain}_final.jsonl"
